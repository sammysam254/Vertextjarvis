...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateStatus(String state) {
        ...
        switch (state) {
            ...
            case "AWAKE_LISTENING_COMMAND": tvStatus.setText("Awaiting your command, Sir..."); break;
            case "PROCESSING": tvStatus.setText("Processing..."); break;
            default: tvStatus.setText("Standing by...");
        }
    }
        ...
        try {
            ...
            new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Save", (d, w) -> {
                    prefs.edit().putString("api_key", etApiKey.getText().toString().trim()).apply();
